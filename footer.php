		...
		<div class="site-info pageWidth">
			...
			<ul>
				...
				<li>
					...
					<a href="/endlessExpansion/tattoo-services/" class="footerLink">Tattoo Services</a>

				</li>

				<li>

					<a href="/endlessExpansion/tattoo-portfolio/" class="footerLink">Tattoo Portfolio</a>

				</li>

				<li>

					<a href="/endlessExpansion/about/" class="footerLink">About</a>

				</li>

				<li>

					<a href="/endlessExpansion/client-deposits/" class="footerLink">Client Deposits</a>

				</li>

				<li>

					<a  href="/endlessExpansion/contact/" class="footerLink">Contact</a>
				...
				<div class="copyrightContentWrap navWidth">
					...
					<div id="copyrightWrap">
						...
						<div id="closingLinks">
							...
							<a href="/endlessExpansion/sitemap/" class="borderRight">Sitemap</a> |

							<a href="/endlessExpansion/privacy-policy/" class="borderRight ">Privacy Policy</a> |

							<a href="/endlessExpansion/contact/" id="footerContactLink">Contact Us</a>
