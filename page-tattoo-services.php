	...
	<main id="main" class="site-main">
		...
		<section class ="endlessIntro">
			<div class="navWidth flex-container centerAlignedContainer endlessLogoOpaque">
				<div class="col70 whiteText limitWidth">
					...
					<p>
						At Endless Expansion Custom Tattoo, you'll experience a one on one creative and relaxing experience. Whether you're getting ready for your
		...
		<section id ="customTattooServices">
			<div class="contentBlock flex-container-reverse centerAlignedContainer">
				<div class="col50">
					<img src="/wp-content/uploads/2020/02/large-colorful-custom-back-tattoo.jpg"
					 class="image borderedImageLeft" alt="Colorful Japanese Style Dragon tattoo by Green Bay tattoo artist Greg Counard">
				</div>
				<div class="col50">
					<div class="blockText">
			...
			<div class="contentBlock flex-container centerAlignedContainer">
				<div class="col50">
					<div class="blockText">
						...
						<div class="textUnderline"></div>
						<p>
							At Endless Expansion tattooing is a form of therapy. It starts with the proper environment where you feel comfortable, safe, and completely private. Whether you need to talk or a quiet ear to listen, private sessions are important so you feel comfortable bringing up anything that may come to mind.
						</p>
						<p>
